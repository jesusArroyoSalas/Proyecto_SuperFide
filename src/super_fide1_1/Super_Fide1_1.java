    ...
    public static void main(String[] args) {
        ...
        switch(op) {
            case 1:
                ...
                int telefono_c = Integer.parseInt(JOptionPane.showInputDialog("Por favor digite el numero de telefono del cliente"));
            ...
            break;
            case 3:               
                fide_promo.precio_promo(fide_P);                       
                // code block
            break;
            case 4:
            ...
            break;
            case 5:
                facturar fide_Fac  = new facturar(fide, fide_A, fide_P, fide_promo);
                fide_Fac.facturar();
                // code block
            break;
            case 0:
