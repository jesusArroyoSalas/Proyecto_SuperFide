...
public class Afiliacion {
    ...
    private int telefono_c = 0;
    private String correo_c;
    private String direccion_c;
    
    public void Afiliacion(){}
    public void Afiliacion(String nom, String ced, int tel, String correo, String direc){
        nombre_c = nom;
        cedula_c = ced;
        telefono_c = tel;
        correo_c = correo;
    ...
    public void imprimir_AF (){
        if(telefono_c == 0){
                JOptionPane.showMessageDialog(null, "NO SE HA AFILIADO NINGUN CLIENTE");
        }
        else {
